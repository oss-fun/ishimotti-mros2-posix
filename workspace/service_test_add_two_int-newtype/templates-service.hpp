...
template mros2::Subscriber mros2::Node::create_service_subscription<service_msgs::msg::add_two_int_client>(std::string topic_name, int qos, void (*fp)(service_msgs::msg::add_two_int_client *));
